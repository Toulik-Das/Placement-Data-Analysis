...
## Installation <a name="files"></a>
 ...
 Firstly Install Python 3.0 [Click here](https://www.youtube.com/watch?v=4Rx_JRkwAjY) and Jupyter Notebook [Click here](https://jupyter.readthedocs.io/en/latest/install.html).
